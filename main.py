...
@app.post("/api/users", 
          response_model=UserResponse, # pynadtic excutes automatically exexcute's after "return new_user"
...
def update_post_partial(post_id: int, 
    ...
    update_data = post_data.model_dump(exclude_unset=True) # Only update the exact content and reset of the things same
